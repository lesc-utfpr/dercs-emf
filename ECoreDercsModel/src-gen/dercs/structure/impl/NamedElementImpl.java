 ...
 * </p>
 * <ul>
 *   <li>{@link dercs.structure.impl.NamedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link dercs.structure.impl.NamedElementImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	public EList<String> getTags() {
		if (tags == null) {
			tags = new EDataTypeUniqueEList<String>(String.class, this, StructurePackage.NAMED_ELEMENT__TAGS);
		}
		return tags;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case StructurePackage.NAMED_ELEMENT__NAME:
			return getName();
		case StructurePackage.NAMED_ELEMENT__TAGS:
			return getTags();
		}
