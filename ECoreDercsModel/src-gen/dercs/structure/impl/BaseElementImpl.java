 ...
 * </p>
 * <ul>
 *   <li>{@link dercs.structure.impl.BaseElementImpl#isStatic <em>Static</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseElementImpl extends NamedElementImpl implements BaseElement {
	...
	protected EClass eStaticClass() {
		return StructurePackage.Literals.BASE_ELEMENT;
	}
	...
	public void setStatic(boolean newStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.BASE_ELEMENT__STATIC, oldStatic,
					static_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StructurePackage.BASE_ELEMENT__STATIC:
			return isStatic();
		}
