...
public class StructureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StructurePackage.CLASS: {
			dercs.structure.Class class_ = (dercs.structure.Class) theEObject;
			T result = caseClass(class_);
			if (result == null)
				result = caseBaseElement(class_);
			if (result == null)
		...
		case StructurePackage.ATTRIBUTE: {
			...
			if (result == null)
				result = caseRuntimeElement(attribute);
			if (result == null)
				result = caseBaseElement(attribute);
			if (result == null)
		...
		case StructurePackage.CONSTRUCTOR: {
			Constructor constructor = (Constructor) theEObject;
			T result = caseConstructor(constructor);
			if (result == null)
				result = caseMethod(constructor);
			if (result == null)
				result = caseBaseElement(constructor);
			if (result == null)
		...
		case StructurePackage.DESTRUCTOR: {
			Destructor destructor = (Destructor) theEObject;
			T result = caseDestructor(destructor);
			if (result == null)
				result = caseMethod(destructor);
			if (result == null)
				result = caseBaseElement(destructor);
			if (result == null)
				result = caseNamedElement(destructor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseClass(dercs.structure.Class object) {
		return null;
	}
